        ...
        <div class="container px-5 py-24 mx-auto">
          <div class="flex flex-wrap -m-4">
            <div class="lg:w-1/4 md:w-1/2 p-4 w-full">
              <Link href={'/products/wear-the-code'} class="block relative rounded overflow-hidden">
                <img alt="ecommerce" class="object-cover object-center w-full h-full block" src="https://cdn.shopify.com/s/files/1/0410/0250/0260/products/BM-MV0017_1_1800x1800.jpg?v=1641279626" />
              </Link>
              <div class="mt-4">
