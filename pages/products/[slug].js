                ...
                <div className="container px-5 py-24 mx-auto">
                    <div className="lg:w-4/5 mx-auto flex flex-wrap">
                        ...
                        <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
                            <h2 className="text-sm title-font text-gray-500 tracking-widest">MARVEL</h2>
                                    ...
                                    {Object.keys(variants).includes("red") &&
                                        Object.keys(variants["red"]).includes(size) && (
                                            <button
                                                ...
                                                className={`border-2 rounded-full bg-red-600 hover:bg-red-500 w-6 h-6 focus:outline-none ${color === "red" ? "border-black" : "border-gray-300"
                                                    }`}></button>
                                        )}
                                ...
                                <div className="flex ml-6 items-center">
                                    ...
                                    <div className="relative">
                                        <select
                                            ...
                                            className="rounded border border-gray-700 focus:ring-2 focus:ring-red-900 bg-transparent appearance-none py-2 focus:outline-none focus:border-red-500 text-white pl-3 pr-10">
                            ...
                            <div className='pin'>
                                <input onChange={onChangePin} className="rounded border border-gray-700 focus:ring-2 focus:ring-red-900 bg-transparent appearance-none py-1 focus:outline-none focus:border-red-500 text-white pl-3 pr-10 my-2 mt-8" placeholder='Check your pincode here' />

                                <button onClick={checkServiceAvailability} className="flex  text-white bg-red-500 border-0 py-1 px-4 focus:outline-none hover:bg-red-600 rounded ">
                                    Check
                                </button>

                                {!service && service != null && <div className="Otext-red-700 text-sm mt-3">

                                    Sorry! We do not deliver to this pincode yet

                                </div>}

                                {service && service != null && <div className="Otext-green-700 text-sm mt-3">
                                    Yahoo! We deliver to this pincode
                                </div>}
                            </div>
                        </div>
                    </div>
